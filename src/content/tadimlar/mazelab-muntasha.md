...
rating:
  ...
  flavorNotes:
    ...
    - Tropikal
---
Bu sayfada bir kez daha Prag'a uğruyoruz. Bu sefer fincanın arkasındaki isim Mazelab — şehrin kahve sahnesinde adını
hem tezgahta hem de yarışma masasında duyurmuş bir ekip. Kurucuları Jackie ve Thu'nun hikayesi de aslında bir kahve
dükkanında başlıyor; ikisi orada tanışıyor, sonra hayatı da işi de birlikte kuruyorlar.

Jackie'nin geçmişi tasarım ve fotoğrafçılık. Mazelab fikri ise İzlanda yolculuğunda doğmuş: bir kahve dükkanını bir
fotoğraf galerisiyle birleştirmek. İlk kafeleri latte art ile ün yapsa da Jackie işin estetikte bitmediğini, asıl
